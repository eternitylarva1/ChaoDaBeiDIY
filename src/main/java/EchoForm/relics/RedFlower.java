...
public class RedFlower extends CustomRelic {
    public static final String ID = "echoForm:RedFlower";
    private static final RelicStrings relicStrings = CardCrawlGame.languagePack.getRelicStrings(ID);
    public static final String NAME = relicStrings.NAME;
    public static final String[] DESCRIPTIONS = relicStrings.DESCRIPTIONS;
    private static final String IMG = "echoFormResources/images/relics/RedFlower.png";
    
    private static final int DEXTERITY_AMOUNT = 6;
    private static final int BLOCK_AMOUNT = 21;
    ...
    public void onPlayCard(AbstractCard card, AbstractMonster m) {
        // 当你打出一张技能牌时，获得6点敏捷，获得21点格挡，获得一张奇迹
